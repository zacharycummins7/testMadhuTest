		...
		// Method to determine if alert pop-up present
			public boolean isAlertPresent() {
			  ...
			  public void takeScreenShot() {
				String date = new SimpleDateFormat("MM_dd_yyyy_HHmm").format(new Date());
				  File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
				  // Now you can do whatever you need to do with it, for example copy somewhere
				  try {
					 
					String filePath = 	"C:\\Users\\automation\\Desktop\\JAVA\\ScreenShots\\loginTest-";
					FileUtils.copyFile(scrFile, new File(filePath + date +  ".png"));
				} catch (IOException e) {
